...
function CommentForm({ isSubmitting, onSubmit }: CommentFormProps) {
    ...
    const handleKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
        if (e.key === "Tab") {
          ...
          // After state updates, wait for DOM update, then set cursor
          setTimeout(() => {
        ...
        <form onSubmit={handleSubmit} className="mb-8" >
            ...
            {isPreview ? (
                ...
                <textarea
                    ...
                    className="w-full bg-transparent border-0 text-[#e1e1e3]   placeholder:text-[#808086] resize-none min-h-[120px] p-4 font-mono text-sm focus:outline-none"
                />
            )}
