...
function LanguageSelector({hasAccess}: {hasAccess: boolean}) {
    ...
    const handleLanguageSelect = (language: string) =>{
        if(!hasAccess && language !== "cpp") return;
  ...
  return (
    <div className='relative'  ref = {dropDownRef}>
      ...
      >
        ...
        {/* Decorations */}
        <div
          className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/5 rounded-lg opacity-0 
      ...
      <AnimatePresence>
        {isOpen && (
            <motion.div
                ...
                className="absolute top-full left-0 mt-2 w-64 bg-[#1e1e2e]/95 baxkdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-50"
            >
                  ...
                  {Object.values(LANGUAGE_CONFIG).map((lang , index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {/* decorator */}
                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-500" />
